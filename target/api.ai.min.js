...
"Recorder undefined")}var b=this;this.recorder?a():this.init(a)};e.prototype.close=function(){clearInterval(this.intervalKey);this.recorder&&(this.recorder.stop(),this.recorder.clear(),this.onEvent(11,"Stopped recording"));this.ws&&(this.ws.close(),this.ws=null)};e.prototype._socketSend=function(a){if(this.ws){var b=this.ws.readyState;if(1!=b){var c="WebSocket: ";switch(b){case 0:c+="The connection is not yet open.";break;case 2:c+="The connection is in the process of closing.";break;case 3:c+=
"The connection is closed or couldn't be opened."}this.onError(2,c+(" readyState="+b+" (!=1) failed to send: "+a))}if(a instanceof Blob)if(0<a.size)this.ws.send(a),this.onEvent(5,"Send: blob: "+a.type+", "+a.size);else this.onEvent(6,"Send: blob: "+a.type+", EMPTY");else this.ws.send(a),this.onEvent(7,"Send string: "+a)}else this.onError(5,"No web socket connection: failed to send: "+a)};window.ApiAi=e})();
